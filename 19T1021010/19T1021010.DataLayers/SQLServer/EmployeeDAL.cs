...
{
    /// <summary>
    /// Cài đặt phép xử lý dữ liệu cho nhân viên
    /// </summary>
    public class EmployeeDAL : _BaseDAL, ICommonDAL<Employee>
    {
        ...
        /// <summary>
        /// Đếm số lượng nhân viên tìm kiếm được theo tên
        /// </summary>
        ...
        /// </summary>
        /// <param name="id">Id của nhâ viên</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Kiểm tra thông tin nhân viên có tồn tại trong bảng khác không
        /// </summary>
        ...
        /// <summary>
        /// Hiển thị thông nhân viên tìm kiếm được theo phân trang
        /// </summary>
        /// <param name="page">Số trang</param>
        /// <param name="pageSize">Số lượng nhân viên trên 1 trang</param>
        /// <param name="searchValue">Giá trị tìm kiếm theo tên(nếu không nhập thì lấy toàn bộ)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="data">Id của nhân viên</param>
        /// <returns></returns>
